...
(function(){
  'use strict';
  var getByteArray, createChecker, toString$ = {}.toString, replace$ = ''.replace, split$ = ''.split, slice$ = [].slice;
  getByteArray = function(value){
    var ref$;
    return (ref$ = getByteArray._cache || (getByteArray._cache = {}))[value] || (ref$[value] = toString$.call(value).slice(8, -1) === 'RegExp'
      ? (function(){
        var i$, x$, ref$, len$, results$ = [];
        for (i$ = 0, len$ = (ref$ = (replace$.call(value.source, /\W/g, '')).match(/../g)).length; i$ < len$; ++i$) {
          x$ = ref$[i$];
      ...
      : (function(){
        var i$, x$, ref$, len$, results$ = [];
        for (i$ = 0, len$ = (ref$ = split$.call(value, '')).length; i$ < len$; ++i$) {
          x$ = ref$[i$];
      ...
      return args.every(function(it){
        ...
        x$ = arr.some(function(it){
          return it.every((function(it){
            return it === buffer[offset + arguments[1]];
          }));
        });
        if (x$) {
          offset += arr[0].length;
  ...
  module.exports = function(buffer){
    ...
    checkMp3 = function(offset){
      return c(offset, 'ID3') || c(offset, /FF/) && buffer[offset + 1] & 0xE2 === 0xE2;
    };
    return function(it){
      return (it != null ? {
        ext: it[0],
